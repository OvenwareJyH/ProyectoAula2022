<%-- 
    Document   : comunidad2
    Created on : Nov 18, 2022, 9:48:22 AM
    Author     : alumno
--%>
        ...
        <div class="container-xxl" align="center">
            ...
            <div class="row" style="width: 100%">
                ...
                try{
                    ...
                    String strQry = "select distinct p.*, q.*, r.Nom_Usr from Posts p, Post_Usuario q, Usuarios r where p.ID_Posts = q.ID_Posts and q.ID_Usr = r.ID_Usr;";
                    ResultSet rs = null;
