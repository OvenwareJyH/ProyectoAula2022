        ...
        <div class="container-xxl" align="center">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item dropdown text-right">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="#">Método de pago</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
            ...
            <% 
                try{
                    ...
                    String strQry = "select distinct p.*, q.ID_Usr, r.Nom_Vend from Producto p, Producto_Vendedores q, Vendedores r where	 p.ID_Prod = q.ID_Prod and q.ID_Usr = r.ID_Usr;";
                    ResultSet rs= null;
