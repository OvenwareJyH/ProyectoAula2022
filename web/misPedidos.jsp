<%-- 
    Document   : misPedidos
    Created on : 8 nov. 2022, 21:41:42
    Author     : JorgeEsteban
--%>
...
<html>
    <head>
        ...
        <title>Mis Pedidos | Re-Bátiz</title>
       ...
       <!-- Inicio navbar-->
        ...
        <div class="container justify-content-center" style="background-color: #F8F0F0; border-radius: 15px; width: 90%; align-content: center">
            <div class="row justify-content-center">
                <br><br><br><br><br><br>
                <div class="col col-11 align-self-center fs-1" align="center" style="background-color: #FFFFFF"><b>Mis Pedidos</b></div>
            </div>
            ...
            try{
                ...
                String strQry = "select distinct p.*, r.ID_Usr,Nom_Usr from Posts p, Post_Usuario q, Usuarios r where p.ID_Posts = q.ID_Posts and r.ID_Usr = '"+Id+"';";
                ResultSet rs = null;
                ...
                if(!rs.next()){
                    ...
                    %>
                    <img src="img/carro.png" style="align-items: center; width: 300px" height="200px" width="200px" align="center">
                    <p class="fs-5 fw-light" id="a1">Parece que no tienes objetos pedidos, <a href="principal.jsp">¿quisieras ordenar algo?</a></p>
            <%        
                }
